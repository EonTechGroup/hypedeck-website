    ...
    <div class="relative sm:px-24 px-5" style="background: url('{{ asset('images/home-image.webp') }}'); background-repeat: no-repeat; height:100%; width: auto; background-size: cover; background-position: center">
        <div class="font-sans text-white pt-32 sm:block flex flex-col sm:text-left text-center ">
            ...
            <div class="mt-14 flex flex-row flex-start justify-center sm:justify-start">
                <button class="bg-[#1764DF] text-white xl:p-4 lg:p-2 p-1 rounded-full font-sans font-medium xl:text-xl lg:text-lg text-base xl:h-16 lg:h-14 h-12 xl:w-72 lg:w-64 w-56">Book Free Consultation</button>
                <a class="xl:h-16 lg:h-14 h-12 xl:w-16 lg:w-14 w-12 bg-[#1764DF] flex justify-center items-center rounded-full ml-2.5" href="">
        ...
        <div class="absolute inset-x-0 2xl:bottom-10 xl:bottom-12 md:bottom-10 bottom-10 flex justify-center">
            <a class="sm:h-20 sm:w-20 h-16 w-16 bg-[#1764DF] flex justify-center items-center rounded-full border-[6px] border-white" href="#services">
            ...
            <div class="flex flex-row items-center justify-between">
                <div class="max-w-[620px] sm:pl-10 px-4 space-y-6 py-5 sm:text-left text-center sm:inline flex items-center flex-col">
                    ...
                    <div class="font-normal xl:text-xl lg:text-lg sm:text-base text-[#012F6A]">
                        ...
                        empowering brands to unleash their creativity and achieve unparalleled success in the digital landscape.
                    </div>
                </div>
                <div class="lg:w-[428px] lg:h-[350px] h-[250px] w-[328px] md:flex hidden justify-center items-center" style="background-image: url('{{ asset('images/bg-img.webp') }}'); background-repeat: no-repeat; background-size: cover; background-position: center">
