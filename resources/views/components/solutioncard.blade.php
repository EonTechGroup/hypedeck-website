...
<div
    class="solutionCard w-11/12 h-[20rem] py-8 px-6 md:px-5 space-y-6 sm:space-y-8 md:space-y-4 lg:space-y-6 lg:py-8 lg:px-6 sm:w-8/12 md:w-[31%] md:h-[18.5rem] lg:w-[18rem] lg:h-[21rem] bg-white xl:w-[22rem] xl:h-[24rem] xl:py-10 xl:px-8 flex flex-col xl:space-y-8 rounded-3xl shadow-lg hover:bg-[#1764DF] hover:shadow-[#90bafd] group">
