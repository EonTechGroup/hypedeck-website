...
<div class=" h-full mx-5 my-9">
    <div class="h-72 w-full p-3 shadow-lg shadow-slate-300 rounded-2xl flex items-center flex-col bg-white">
        <img class="rounded-full h-[5.5rem] w-[5.5rem] relative bottom-12 shadow-black"
            src="{{ asset('images/'.$proPic.'.webp') }}" />

        <div class="relative bottom-5 space-y-4 flex items-center flex-col">
            <span class=" text-pretty text-[1.1rem] font-bold text-[#012F6A]">{{ $name }}</span>
            <p class="text-[#012F6A] text-[0.83rem] text-center w-[94%] leading-6">
                {{ $paragraph }}
            </p>
