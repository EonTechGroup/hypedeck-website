...
<section class="flex flex-col flex-1">
    <div
        ...
        <h1
            ...
            About us</h1>
        <p
            class="text-[1.1rem] lg:text-[1.3rem] font-semibold leading-[2rem] lg:leading-[2.1rem] lg:tracking-wide text-center w-11/12 lg:w-full">
            Founded by
    ...
    <div
        ...
        <div
            ...
            <p
                class="text-[1.1rem] lg:text-[1.5rem] xl:text-[2rem] font-semibold italic leading-[2.4rem] lg:leading-[2.8rem] tracking-wide text-pretty relative flex flex-col text-left sm:w-9/12 lg:w-fit">
            ...
            <div class="bg-cover bg-center rounded-3xl w-full lg:w-[55%] h-[22rem] relative overflow-hidden"
                style="background-image: url('{{ asset('images/about-pic.webp') }}');">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between items-center w-full xl:ps-12 gap-16 lg:gap-0">
            <div
                class="text-white font-bold text-[3rem] xl:text-[4rem] flex flex-col lg:flex-row items-center gap-10 lg:gap-0">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 relative gap-5 sm:gap-6 md:gap-10 lg:gap-12 directorGrid">
                <x-directorcard name="Kavindu Karunarathna" position="Director" image="Ariyarathna_Director" />
                <x-directorcard name="Ariyarathna" position="Director" image="Ariyarathna_Director" />
            </div>
        </div>
        <div
            class="grid grid-cols-2 w-full h-full sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-5 sm:gap-9 md:gap-12 lg:gap-16 xl:gap-7 relative top-[2rem] sm:top-[2rem] md:top-[3rem] lg:top-[6rem] teamGrid md:place-items-center">
